        ...
        <div class="px-6 py-6 lg:px-8">
            ...
            <form class="space-y-6" action="" autocomplete="off" method="POST">
                <div>
                    ...
                    <input type="text" name="book_title" value="<?php echo $row['title']; ?>" class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" maxlength="70" required>
                </div>
