...
<div class="p-4 flex justify-end">
    <form autocomplete="off">
        ...
        <div class="relative w-96">
            ...
            <input type="search" id="search" class="border-0 block w-full p-4 pl-10 text-sm text-black rounded-lg bg-white focus:border-gray-900" placeholder="Search" onkeyup="mySearch()" maxlength="70">
        </div>
    </form>
</div>
...
<div class="p-4 h-screen overflow-y-auto ">
    <div class="relative overflow-y-auto h-full bg-white shadow-md sm:rounded-lg">
        <table id="table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM `log_history` ORDER BY time_in DESC";
