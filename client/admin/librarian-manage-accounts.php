...
<div class="p-4 pt-6 flex justify-end">
    <form autocomplete="off">
        ...
        <div class="relative md:w-96">
            ...
            <input onkeyup="mySearch()" type="search" id="default-search" class="h-10 border-0 block w-full p-4 pl-10 text-sm text-black rounded-lg bg-white focus:border-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Search">
        </div>
    </form>
</div>
...
<div class="px-4 pt-2 pb-20 h-screen overflow-y-auto">
    <div class="relative overflow-y-auto h-full bg-white shadow-md rounded-lg">
        <table id="table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <!-- SQL Query for displaying the all librarian accounts in the table -->
                <?php
                $i = 0;
                ...
                <tr class="bg-white border-b text-black font-semibold">
                    ...
                    ?>
                    <!-- View registration details depending on the account status -->
                    <?php
                    if ($status == '1') { // Deactivated Aaccount
                    ?>
                                            ...
                                            <form action="#" autocomplete="off">
                                                ...
                                                <div class="grid grid-cols-3 gap-4 mb-6">
                                                    <div>
                                                        ...
                                                        <input type="text" id="username" name="username" class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" disabled value="<?php echo $username ?>">
                                                    </div>
                                                    <div>
                                ...
                                <div class="relative w-full max-w-md max-h-full">
                                    ...
                                    <div class="relative bg-gray-200 rounded-lg shadow">
                                        ...
                                        <div class="px-6 py-6 lg:px-8 pb-2">
                                            ...
                                            <form action="#" autocomplete="off">
                                                <!-- Username, role, and registration date -->
                                                <div class="grid grid-cols-3 gap-4 mb-6">
                                                    <div>
                                                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900">Username</label>
                                                        <input type="text" id="username" name="username" class="bg-gray-50 border border-gray-400 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" disabled value="<?php echo $username ?>">
