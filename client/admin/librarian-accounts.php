...
<div class="p-4 pt-6 flex justify-end">
    <!-- Add button -->
    <a href="./librarian-add-account.php">
    ...
    <form autocomplete="off">
        ...
        <div class="relative md:w-96">
            ...
            <input onkeyup="mySearch()" type="search" id="default-search" class="h-10 border-0 block md:w-full w-48 p-4 pl-10 text-sm text-black rounded-lg bg-white focus:border-gray-500 focus:ring-2 focus:ring-blue-500" placeholder="Search">
        </div>
    </form>
</div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b text-black font-semibold">
                    ...
                    <td class="px-6 py-2 justify-center flex">
                        <a href="./librarian-update-account.php?id=<?php echo $id ?>">
                        ...
                        <a href="./librarian-view-account.php?id=<?php echo $id ?>">
