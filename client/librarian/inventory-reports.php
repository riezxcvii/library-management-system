    ...
    <div class="h-screen flex flex-col bg-gradient-to-b from-blue-400 to-white">
        ...
        <nav class="z-10 sticky top-0 bg-black border-gray-200">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                ...
                ?>
                <!-- SQL Query to retrieve all data about book status -->
                <?php
        ...
        <div class="p-4 pt-6 flex justify-end">
            <form autocomplete="off">
                ...
                <div class="relative md:w-96">
                    ...
                    <input type="search" id="default-search" class="h-10 border-0 block w-full p-4 pl-10 text-sm text-black rounded-lg bg-white focus:border-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Search" required onkeyup="mySearch()">
                </div>
            </form>
        </div>
