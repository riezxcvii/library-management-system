            ...
            <tbody>
                <tr class="bg-white border-b text-black font-semibold">
                    ...
                    <td class="px-6 py-2 justify-center flex">
                        <button type="button" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-2 focus:outline-none focus:ring-blue-300">
                            Return
                        </button>
                    </td>
                </tr>
