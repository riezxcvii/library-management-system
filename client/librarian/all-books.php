...
<div class="p-4 flex justify-end">
    <!--button-->
    <a href="./add-book.php">
        <button type="button" class="h-full inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:outline-none focus:ring-blue-300 mr-8">
            Add Book
        </button>
    </a>
    <!--search bar-->
