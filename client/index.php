            ...
            <form autocomplete="off" action="../server/admin/login.php" method="POST">
                ...
                <div class="mb-6">
                    <label for="username" class="block mb-2 text-sm font-medium text-gray-900">Enter
                        username</label>
                    <input type="text" id="username" name="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 mt-2" minlength="5" maxlength="30" required>
                </div>
                <div class="mb-6">
